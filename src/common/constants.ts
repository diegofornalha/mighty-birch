...
export const RELAYER_URL = process.env.REACT_APP_RELAYER_URL || 'https://dex-backend.verisafe.io/v3';

export const RELAYER_WS_URL = process.env.REACT_APP_RELAYER_WS_URL || 'wss://dex-backend.verisafe.io/websocket/';
...
export const MIN_ORDER_EXPIRATION_TIME_ON_ORDERBOOK = 999999999999999;
